      ...
      <?php foreach($all_events_for_particular_page as $single_event): ?>
            <div class = "single-news">
               <div class = "row">
                  ...
                  <div style = "text-align:center;" class = "col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                     <form style = "margin-top:100px;" action="<?php echo site_url(); ?>/Main/delete_event/<?php echo $single_event['id']; ?>">
                        <button style = "background-color: red;" class = "button" type="submit">Delete This Event</button>
                     </form>
                  </div>
               </div>
            </div>
